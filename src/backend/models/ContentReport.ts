...
import { IBoard } from "./Board"; // **ใหม่**: สำหรับ contentId (ถ้า contentType คือ Board)
 ...
 * - `BOARD`: กระทู้ในเว็บบอร์ด (หัวข้อ, เนื้อหาหลัก)
...
export enum ReportableContentType {
  ...
  BOARD = "Board", // **ใหม่**: เพิ่มการรองรับการรายงานกระทู้
      ...
      if (model) {
        ...
        switch (this.contentType) {
          ...
          case ReportableContentType.MEDIA_ITEM:
            ...
            titleField = "fileName";
            break;
          case ReportableContentType.BOARD: // **ใหม่**: เพิ่ม case สำหรับ Board
            ownerField = "authorId";
            titleField = "title";
            break;
        }
        ...
        if (contentDoc) {
          ...
          // สำหรับ Board จะได้ URL เป็น /app/board/<board_id> ซึ่งสอดคล้องกับ logic เดิม
...
// 10. **Board Model Integration**: โมเดลนี้ได้รองรับการรายงานเนื้อหาประเภท 'Board' แล้ว อย่างไรก็ตาม ในฝั่งของ BoardModel.ts
//     ควรมีการตรวจสอบ Middleware ที่จัดการการลบกระทู้ (post `findOneAndDelete`) เพื่อให้แน่ใจว่าได้อัปเดต ContentReport ที่เกี่ยวข้อง
//     โดยใช้ `contentType: "Board"` อย่างถูกต้องเมื่อทำการล้างข้อมูล
// ==================================================================================================