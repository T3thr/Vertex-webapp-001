...
import UserModelImport, { IUser, IWriterStats, INovelPerformanceStats } from "@/backend/models/User"; // ตรวจสอบ path และ import ที่จำเป็น
...
async function generateSampleNovels(authorId: Types.ObjectId): Promise<Partial<INovel>[]> {
  ...
  const sampleNovelsData: Partial<INovel>[] = [
    { // นิยายที่ 1: "เงาแห่งนิรันดร์กาล" - ***มีโปรโมชัน***
      ...
      slug: generateSlug("เงาแห่งนิรันดร์กาล"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 2: "ความฝันสีนีออน" - ***มีโปรโมชัน***
      ...
      slug: generateSlug("ความฝันสีนีออน"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 3: "เสียงกระซิบจากพงไพร" - ไม่มีโปรโมชัน, ฟรี
      ...
      slug: generateSlug("เสียงกระซิบจากพงไพร"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 4: "มรดกแห่งดวงดาว" - ไม่มีโปรโมชัน, อยู่ในสถานะ draft
      ...
      slug: generateSlug("มรดกแห่งดวงดาว"), // slug generated
      author: authorId,
      ...
      themeAssignment: {
        ...
        customTags: ["สงครามอวกาศ", "อาวุธโบราณ", "วีรบุรุษ поневоле"], // Note: "วีรบุรุษ поневоле" contains Cyrillic. Slug function will handle.
      },
      narrativeFocus: {
        narrativePacingTags: [getSafeRandomCategoryId(CategoryType.NARRATIVE_PACING, "fast-paced")].filter(Boolean) as Types.ObjectId[],
    ...
    { // นิยายที่ 5: "ฟากฟ้าสีชาด" - ไม่มีโปรโมชัน
      title: "ฟากฟ้าสีชาด",
      slug: generateSlug("ฟากฟ้าสีชาด"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 6: "เสียงสะท้อนจากห้วงลึก" - ฟรี
      ...
      slug: generateSlug("เสียงสะท้อนจากห้วงลึก"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 7: "บทเพลงรัตติกาล" - ***มีโปรโมชัน และเป็น Premium Exclusive***
      ...
      slug: generateSlug("บทเพลงรัตติกาล"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 8: "ศาสดาแห่งโลกดิจิทัล" - ฟรี
      ...
      slug: generateSlug("ศาสดาแห่งโลกดิจิทัล"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 9: "เถ้าธุลีแห่งฟีนิกซ์" - ไม่มีโปรโมชัน
      ...
      slug: generateSlug("เถ้าธุลีแห่งฟีนิกซ์"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 10: "รหัสลับบรรณารักษ์" - ฟรี
      ...
      slug: generateSlug("รหัสลับบรรณารักษ์"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 11: "นักแปรธาตุข้ามเวลา" - ไม่มีโปรโมชัน
      ...
      slug: generateSlug("นักแปรธาตุข้ามเวลา"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 12: "คลื่นความถี่มรณะ" - Premium Exclusive แต่ไม่มีโปรโมชัน
      ...
      slug: generateSlug("คลื่นความถี่มรณะ"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 13: "สวนแก้วกลางเมืองปูน" - ฟรี
      ...
      slug: generateSlug("สวนแก้วกลางเมืองปูน"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 14: "ท่วงทำนองควอนตัม" - ไม่มีโปรโมชัน
      ...
      slug: generateSlug("ท่วงทำนองควอนตัม"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 15: "นักเขียนแผนที่เที่ยงคืน" - ฟรี
      ...
      slug: generateSlug("นักเขียนแผนที่เที่ยงคืน"), // slug generated
      author: authorId,
    ...
    { // นิยายที่ 16: "วิญญาณเมืองกรุง" - ไม่มีโปรโมชัน
      ...
      slug: generateSlug("วิญญาณเมืองกรุง"), // slug generated
      author: authorId,
